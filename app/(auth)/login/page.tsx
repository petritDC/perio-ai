    ...
    <div className="min-h-screen bg-[#F7F9FC] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8" style={{ boxShadow: 'var(--shadow-card)' }}>
          ...
          <p className="text-[14px] text-slate-500 mb-6">Access your clinic dashboard</p>
          ...
          <p className="text-center text-[13px] text-slate-500 mt-4">
            Not a staff member?{' '}
            <Link href="/patient/login" className="text-teal-600 hover:text-teal-700 font-medium">
              Patient portal →
            </Link>
          </p>
        </div>
